...
def cell_analysis(im: IMGstruct, mask: MaskStruct, filename: str, bestz: int, output_dir: Path, seg_n: int,
    ...
    # for i in range(1):
        ...
        clustercells_tsneAll, clustercells_tsneAll=tSNE_AllFeatures(mask,options,mean_vector_f,covar_matrix_f,total_vector_f,meanAll_vector_f,shape_vectors,texture_matrix)
...
def tSNE_AllFeatures(mask,options,matrix_mean,matrix_cov,matrix_total,matrix_meanAll,matrix_shape,matrix_texture):
    ...
    return clustercells_all,clustercells_allcenters        
